                ...
                <div x-data="{ loading: false }" class="bg-white rounded-2xl shadow p-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="pt-6 border-t">
                            ...
                            <div id="payment" class="woocommerce-checkout-payment space-y-4 [&_input[type=radio]]:accent-blue-600 [&_label]:text-sm [&_label]:text-gray-800">
                                @php if (function_exists('WC') && WC()->checkout()) do_action('woocommerce_checkout_payment'); @endphp
                            </div>
                        </div>
