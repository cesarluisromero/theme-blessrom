...
<div class="space-y-4">
    {{-- Nombre --}}
    <div>
        <label for="billing_first_name" class="block text-sm font-medium text-gray-700">Nombre *</label>
    ...
    {{-- Apellidos --}}
    <div>
        <label for="billing_last_name" class="block text-sm font-medium text-gray-700">Apellidos *</label>
    ...
    {{-- Dirección --}}
    <div>
        <label for="billing_address_1" class="block text-sm font-medium text-gray-700">Dirección *</label>
    ...
    {{-- Código postal --}}
    <div>
        <label for="billing_postcode" class="block text-sm font-medium text-gray-700">Código postal *</label>
    ...
    {{-- Correo electrónico --}}
    <div>
        <label for="billing_email" class="block text-sm font-medium text-gray-700">Correo electrónico *</label>
