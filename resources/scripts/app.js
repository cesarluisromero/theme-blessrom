...
function alpineCart() {
    ...
    // 🔍 Eliminar previamente los campos sensibles si ya existen
    ...
    // ✅ Añadir los campos necesarios SIN duplicar
    ...
    formData.append('add-to-cart', this.currentVariationId || productId);
